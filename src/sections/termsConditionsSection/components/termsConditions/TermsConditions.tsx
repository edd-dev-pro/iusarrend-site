        ...
        <Row className={styles.spacing}>
          ...
          <Col xs={12}>
            ...
            <p className={styles.textSection}>
              ...
              relacionados con sus bienes, serán utilizados para fines internos
              necesarios para la correcta prestación de los servicios ofrecidos
              por IUSARREND. Entre estos propósitos se encuentran:
            </p>
            <ul className={styles.textSection}>
              ...
              <li>
                Evaluación para la contratación de servicios de arrendamiento,
                análisis de riesgo, y generación de pólizas o contratos.
              </li>
              <li>
              ...
              <li>
                Contacto, atención al cliente, y cumplimiento de obligaciones
                legales y contractuales.
              </li>
            </ul>

            <p className={styles.textSection}>
              Los datos pueden incluir, entre otros: nombre, estado civil, RFC,
              lugar y fecha de nacimiento, nacionalidad, domicilio, teléfonos,
              firma autógrafa, edad, ocupación, domicilio laboral, correos
              electrónicos, referencias personales y laborales, calidad
              migratoria, derechos de residencia, información fiscal, historial
              crediticio, movimientos bancarios, así como cualquier otro dato
              necesario para la evaluación del servicio solicitado.
            </p>
            <p className={styles.textSection}>2. Protección de datos</p>
            <p className={styles.textSection}>
              ...
              S.C. se compromete a no divulgar, compartir ni comercializar sus
              datos personales sin su consentimiento, salvo en los casos
              legalmente permitidos o exigidos por autoridad competente.
            </p>

            <p className={styles.textSection}>3. Derechos ARCO</p>
            <p className={styles.textSection}>
              Usted tiene derecho a ejercer en todo momento sus derechos ARCO,
              que consisten en:
            </p>
            <ul className={styles.textSection}>
              <li>Acceder a sus datos personales.</li>
              <li>Rectificar los datos que sean inexactos o incompletos.</li>
              <li>
            ...
            <p className={styles.textSection}>4. Modificaciones al aviso</p>

            <p className={styles.textSection}>
              Nos reservamos el derecho de realizar modificaciones o
              actualizaciones al presente aviso de privacidad en cualquier
              momento, ya sea para cumplir con reformas legislativas, políticas
              internas o nuevos requerimientos para la prestación de nuestros
              servicios. Cualquier cambio será notificado a través de nuestro
              sitio web oficial.
            </p>
            <p className={styles.textSection}>5. Aceptación del aviso</p>
            <p className={styles.textSection}>
              El uso de nuestros servicios implica el consentimiento expreso del
              titular respecto al tratamiento de sus datos personales conforme a
